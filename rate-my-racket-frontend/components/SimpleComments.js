        ...
        {fake_comments.map((comment, index) => {
            return (
                <Card key={index} className={styles.simple_comments_card}>
                    ...
                    <div className={styles.simple_comments_card_header_avatar}></div>    <div className={styles.simple_comments_card_header_title}>{comment.username} - <span className={styles.simple_comments_card_header_span}>{comment.about}</span></div>
                    </Card.Header>
